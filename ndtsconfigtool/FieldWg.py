...
class FieldWg(QWidget, ui_fieldwg.Ui_FieldWg):
    
    ## constructor
    # \param parent patent instance
    def __init__(self, parent=None):
        super(FieldWg, self).__init__(parent)
...
class MDialog(QDialog):
    def __init__(self,  parent = None):
        ...
        self.form.units = 'cm'
        self.form.attributes = {"signal":"1","long_name":"source detector distance", "interpretation":"spectrum"}
        self.form.doc = """Distance between the source and the mca detector.
#It should be defined by client."""
        self.form.dimensions = [3]
        self.form.dimDoc = "(x,y,z) coordinates"
        self.form.value ="1.23,3.43,4.23"

        self.form.createGUI()
        
        QObject.connect(self.form.buttonBox, SIGNAL("accepted()"), self.accept)
        QObject.connect(self.form.buttonBox, SIGNAL("rejected()"), self.reject)
