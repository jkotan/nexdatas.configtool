...
#        self.assertTrue(form.ui.savePushButton.hasFocus())
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_setFromNode_parameter(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_setFromNode_clean(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_populateAttribute_setFromNode(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_populateAttribute_setFromNode_selected_wrong(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_populateAttribute_setFromNode_selected(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_updateNode_withindex(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.show()
...
#        self.assertTrue(isinstance(form.dts, DomTools))
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.show()
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_button(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action_button(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def tttest_connect_actions_with_action_and_apply_button(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action_and_sapply_button(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action_and_slink_button(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action_and_apply_button_noname(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_connect_actions_with_action_link_and_apply_button_noname(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
        form = CommonDataSourceDlg()
        form.ui = Ui_CommonDataSourceDlg() 
    ...
    ## constructor test
    # \brief It tests default settings
    def ttest_appendElement_error(self):
        fun = sys._getframe().f_code.co_name
        print "Run: %s.%s() " % (self.__class__.__name__, fun)  
