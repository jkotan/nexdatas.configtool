...
#        mb.accept()
    ...
    def test_constructor(self):
        ...
        self.assertEqual(form.ui.__class__.__name__, "Ui_FieldDlg")
        ...
        self.assertEqual(form.replaceText,
                         super(FieldDlg, form).replaceText)
        self.assertEqual(form.removeElement,
                         super(FieldDlg, form).removeElement)
        self.assertEqual(form.replaceElement,
                         super(FieldDlg, form).replaceElement)
        self.assertTrue(form.appendElement is not
                        super(FieldDlg, form).appendElement)
