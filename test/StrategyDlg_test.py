...
#        mb.accept()
    ...
    def test_constructor(self):
        ...
        self.assertEqual(form.ui.__class__.__name__, "Ui_StrategyDlg")
        self.assertTrue(isinstance(form, NodeDlg))
        self.assertEqual(form.externalApply, None)
        self.assertEqual(
            form.externalDSLink, None)

        self.assertEqual(
            form.replaceText, super(StrategyDlg, form).replaceText)
        self.assertEqual(
            form.removeElement, super(StrategyDlg, form).removeElement)
        self.assertEqual(
            form.replaceElement, super(StrategyDlg, form).replaceElement)
        self.assertTrue(
            form.appendElement is not super(StrategyDlg, form).appendElement)
    ...
    def test_constructor_accept(self):
        ...
        self.assertTrue(not form.ui.triggerLineEdit.text())
        self.assertEqual(form.ui.growsSpinBox.value(), 0)

        self.assertTrue(not form.ui.postLineEdit.text())
        ...
        self.assertTrue(bool(form.ui.triggerLineEdit.text()))
        self.assertEqual(form.ui.growsSpinBox.value(), 0)

        self.assertTrue(bool(form.ui.postLineEdit.text()))
...
#        self.assertEqual(form.nexusType, nType)
    ...
    def test_updateForm(self):
        ...
        self.assertTrue(not form.ui.triggerLineEdit.text())
        self.assertEqual(
            form.ui.growsSpinBox.value(), grows if grows > 0 else 0)
        self.assertTrue(not form.ui.postLineEdit.text())
    ...
    def test_getState(self):
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', False, 5, True, False, u''))

        form.mode = mode

        self.assertEqual(
            form.getState(),
            (mode, u'', u'', u'', False, 5, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', trigger, u'', u'', False, 5, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', grows, u'', False, 5, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', post, False, 5, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', compr, 5, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', False, 5, True, canf, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', False, rate, True, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', False, 5, shuffle, False, u''))
        ...
        self.assertEqual(
            form.getState(),
            ('STEP', u'', u'', u'', False, 5, True, False, doc))
        ...
        self.assertEqual(
            form.getState(),
            (mode, trigger, grows, post, compr, rate, shuffle, canf, doc))
    ...
    def test_setState(self):
        ...
        self.assertEqual(form.setState(
            [mode,  u'', u'', u'', False, 5, True, False, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  trigger, u'', u'', False, 5, True, False, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  u'', grows, u'', False, 5, True, False, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  u'', u'', post, False, 5, True, False, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  u'', u'', u'', compr, 5, True, False, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  u'', u'', u'', False, 5, True, canf, u'']), None)
        ...
        self.assertEqual(form.setState(
            ['STEP',  u'', u'', u'', False, rate, True, False, u'']), None)
        ...
        self.assertEqual(
            form.setState(['STEP',  u'', u'', u'', False, 5, True,
                           False, doc]), None)
        ...
        self.assertEqual(
            form.setState(
                [mode, trigger, grows, post, compr, rate,
                 shuffle, canf, doc]), None)
...
#        olddoc, "".join(["\nText\n %s\n" % n for n in range(ndcs)]).strip())
    ...
    def test_apply(self):
        ...
        self.assertEqual(
            form.grows,
            str(ngrows) if nmode == 'STEP' and ngrows > 0 else '')
